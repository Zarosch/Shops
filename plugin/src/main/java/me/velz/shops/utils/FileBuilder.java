    ...
    public void addDefault(String path, ItemStack stack) {
        if (!this.configuration.contains(path)) {
            ...
            if (stack.getItemMeta() != null) {
                ...
                if (Shops.getPlugin().getVersion().isUnbreakable(stack)) {
                ...
                try {
                    ...
                    if (Shops.getPlugin().getVersion().getSkullOwner(skullMeta) != null) {
                        this.configuration.set(path + ".meta.owningPlayer", Shops.getPlugin().getVersion().getSkullOwner(skullMeta));
                    }
                } catch (ClassCastException ex) {
                }
